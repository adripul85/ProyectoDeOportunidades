            ...
            <div className="prose prose-slate max-w-none space-y-8">
                ...
                <section className="bg-light-50 p-8 rounded-[32px] border border-light-200">
                    ...
                    <div className="space-y-4 text-gray-600">
                        <p>Vendelo Ya! funciona exclusivamente como un espacio de publicación de anuncios clasificados.</p>
                ...
                <section className="bg-light-50 p-8 rounded-[32px] border border-light-200">
                    ...
                    <div className="space-y-4 text-gray-600">
                        ...
                        <div className="bg-red-50 p-6 rounded-2xl mt-6">
                            <p className="font-bold text-red-800 mb-2">Vendelo Ya! no garantiza:</p>
                ...
                <section className="bg-light-50 p-8 rounded-[32px] border border-light-200 border-l-4 border-l-orange-500">
                    ...
                    <div className="space-y-4 text-gray-600">
                        <p>Vendelo Ya! no será responsable por daños directos o indirectos derivados del uso de la plataforma o de las transacciones realizadas entre usuarios.</p>
                    </div>
                </section>
