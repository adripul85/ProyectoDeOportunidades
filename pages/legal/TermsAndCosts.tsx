                ...
                <div className="max-w-4xl mx-auto space-y-12">
                    <section>
                        ...
                        <div className="bg-white p-10 rounded-[40px] border border-light-200 shadow-sm space-y-6 text-sm text-gray-600 leading-relaxed font-medium">
                            <p>
                                En <strong>De Oportunidades</strong>, su privacidad es un pilar fundamental de nuestra arquitectura. Utilizamos encriptación de extremo a extremo para todos los datos sensibles.
                            </p>
